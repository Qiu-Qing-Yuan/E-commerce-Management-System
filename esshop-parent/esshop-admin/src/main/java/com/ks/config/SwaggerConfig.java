...
//        Docket docket = new Docket(DocumentationType.SWAGGER_2); //指定文档风格
        ...
        apiInfoBuilder.title("《商城后台管理系统》后端接口说明")
                .description("该文档详细说明了商城后台管理系统项目后端接口规范")
                .version("v 1.0.1")
                .contact(new Contact("QiuQingyuan","https://github.com/Qiu-Qing-Yuan","jiujiuweigong@outlook.com"));
